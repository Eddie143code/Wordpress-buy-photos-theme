...
class ProductModal {
  ...
  constructor() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].defaults.headers.common["X-WP-Nonce"] = websiteData.nonce;
    this.events();
  }
  ...
  post_order_to_db(e) {
    ...
    const post = async () => {
      try {
        const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(websiteData.root_url + "/wp-json/wp/v2/orders", ourNewPost);
