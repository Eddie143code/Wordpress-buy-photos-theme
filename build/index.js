...
class ProductModal {
  ...
  addEventListeners() {
    ...
    document.querySelector(".close_product_button").addEventListener("click", () => {
      this.toggleProductModal();
    });
    this.cartButton.addEventListener("click", () => {
      this.toggleCartModal();
    });
    document.querySelector(".close_cart_button").addEventListener("click", () => {
      this.toggleCartModal();
    });
    document.querySelectorAll(".add_other_product_to_cart").forEach((button, index) => {
      button.addEventListener("click", () => {
        this.addProductToCart(this.allOtherProducts[index], this.allImages[index]);
      });
    });
    document.querySelectorAll(".add_main_product_to_cart").forEach((button, index) => {
      button.addEventListener("click", () => {
    ...
    document.querySelector(".close_payment_form").addEventListener("click", () => {
      this.paymentModal.classList.remove("show_payment_modal");
    });
    document.querySelector(".submit_payment_form").addEventListener("click", () => {
      this.postOrderToDB();
    });
  }
  toggleProductModal() {
  ...
  updateCartTotal() {
    ...
    const total = this.cartItems.reduce((sum, current) => sum + current.item, 0);
  ...
  postOrderToDB() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(websiteData.root_url + "/wp-json/wp/v2/orders", ourNewPost).then(response => {
