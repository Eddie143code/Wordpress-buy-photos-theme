...
<section id="photo-page" class="section_photos gallery-photo">
    ...
    <article class="payment_modal">
        <form class="payment-form" action="/photos-input" method="post">
            ...
            <div class="flex-form">
                <div><label class="date-cvc" for="expiration-date">Expiration month and year</label><input type="text"
                        name="expiration-date"> </div>
            ...
            if ($_POST) {
                ...
                if ($folders) {
                    ...
                    while ($mainProducts->have_posts()) {
                        ...
                        <div class="container-single_main_product"><span class="single_main_product">
                                <?php echo get_the_title(); ?>: R
                                <?php echo get_field('Price'); ?>
                            </span> <button class="add_main_product_to_cart">add</button></div>
    ...
    <article class="container-other_products ">
        ...
        while ($otherProducts->have_posts()) {
            ...
            $otherProducts->the_post(); ?>
                    ...
                    <div class="container-single_other_product"> <span class="single_other_product">
                            <?php echo get_the_title(); ?>: R
                            <?php echo get_field('Price'); ?>
                        </span> <button class="add_other_product_to_cart">add</button></div>
        ...
        ?>
            ...
            for ($i = 0; $i < $sizeofarray; $i++) {
                ...
                ?>
                <span class="photos-single"> <img id='<?php $i ?>' class="img-single" alt="1" src=<?php echo $post[0] ?> />
                    <button id=<?php echo $i ?> class="product_button">product</button> </span>
                <?php
            }
                }
                ?>
